package com.bakhortechnologies.qr;
...
public class Generator {
    ...
    public static void main(String[] args) {
        try {
            generateQRCodeImage("Thanks that you scanned the QR code.", 350, 350, QR_CODE_IMAGE_PATH);
            System.out.println("QR Code is generated. To view it, open "+ QR_CODE_IMAGE_PATH);
